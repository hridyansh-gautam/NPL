        ...
        \makecell{\texthindi{अंशांकन प्रमाण पत्र}\\\textbf{CALLIBRATION CERTIFICATE:}\\Raman Analysis of given sample}\\[1.5ex]
        \fullhline
        \makecell{\rule{0pt}{1em}\texthindi{प्रमाण पत्र संख्या}/Certificate number:\\ \rule{0pt}{1.5em}N19110969/D1.06/T-272} \\ [1.5ex]
        \fullhline
        ...
        23.12.2019&&\thepage&\pageref{LastPage}\\[1.8ex]
        \fullhline
        \end{tabular}
        }
        ...
        \stepcounter{rownum}\arabic{rownum}. 	&	\makecell[l]{Calibrated for}		&:&	\parbox[t]{7.8cm}{\raggedright Biomedical Instrumentation Metrology Section  \\
CSIR-National Physical Laboratory.  \\
Dr. K.S. Krishnan Marg, New Delhi-110012  \\
Customer's Ref. No.: CTR Form, Dated: 25.11.19} \\
        \stepcounter{rownum}\arabic{rownum}. 	&	\makecell[lt]{Description and Identification \\of Item under Calibration}  &:&	\parbox[t]{7.8cm}{ \raggedright Graphene Oxide, Identification no. Gl} \\
...
Relative Humidity: (50 \textpm 10)\%} \end{minipage}\\
        ...
        \stepcounter{rownum}\arabic{rownum}. 	&	Date(s) for calibration: &	23.12.2019 \\
