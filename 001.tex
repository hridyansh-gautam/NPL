<<<<<<< HEAD
    ...
    \fullhline
    \makecell{\texthindi{डी ओ आई संख्या}/DOI number :\\ 6484863586 }\\[1.5ex]
...
Make: Fluke Biomedical} \\
    \stepcounter{rownum}\arabic{rownum}.	&	\makecell[lt]{Environmental Conditions} 	& :&	 \parbox[t]{7.8cm}{\raggedright Temperature: (25 \textpm 2) \textdegree C \\
Relative Humidity: (50 \textpm 10)\%} \\
    \stepcounter{rownum}\arabic{rownum}.	&	\makecell[lt]{Standard(s) used (with)\\ Associated uncertainty}	&:& \parbox[t]{7.8cm}{\raggedright 1. Digital Storage Oscilloscope (Model No.: TBS 2072; Sr. No.: C020293; Make: Tektronix);  \\
(-182.8 to -582.4) mV \textpm1.5 mV (k=2.32) ;  \\
(215.8 to 2207) mV \textpm (1.5 to 2.0) mV (k=2.02 to 2.32);  \\
Time (sec): (19.994 \textpm1 * 10\^-3) μs (k=2) \\
...
\input{inputs/tables.tex}
    ...
    \hspace{0.9cm}
    \stepcounter{rownum}\arabic{rownum}.	Remark(s):	\qquad ) The measured values of peak wavelength are representation of the nearest reference Standard spectral lines as shown by the Spectrometer at the interval of each 0.1 mm. \\
